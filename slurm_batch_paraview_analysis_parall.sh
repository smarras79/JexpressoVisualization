...
# First run: python3 batch_paraview_analysis_parall.py --suggest-parallel --num-processes $SLURM_NTASKS_PER_NODE
# to see what ranges to use, then customize below:

# USER CONFIGURATION: Modify these ranges based on your actual files
FILE_RANGES=(
    "100 199 1"    # Process 1: files 100-199, step 5
    "200 299 1"    # Process 2: files 200-299, step 5  
#    "300 399 1"    # Process 3: files 300-399, step 5
#    "400 499 1"    # Process 4: files 400-499, step 5
    "500 582 1"    # Process 5: files 500-599, step 5
)
...
for ((i=0; i<NUM_PROCESSES; i++)); do
    ...
    srun --ntasks=1 --exclusive --job-name="paraview_proc_$((i+1))" \
         python3 batch_paraview_analysis_parall.py \
