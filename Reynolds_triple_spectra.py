...
if __name__ == '__main__':
    # --- CONFIGURATION ---
    DATA_DIR = "/scratch/smarras/hw59/output/LESICP1_scaling-8nodes-64x32x36_10kmX10kmX3km/CompEuler/LESICP1/output"
    ...
    OUTPUT_NC_AVERAGED_FILE = DATA_DIR + "/300to450turbulence_statistics_averaged.nc" # File for all time-averaged data
    PROFILE_PLOT_FILE = DATA_DIR + "/300to450vertical_wind_profile.png"
    SECOND_MOMENT_PLOT_DIR = DATA_DIR + "/300to450second_moment_profiles"
    SPECTRA_PLOT_FILE = DATA_DIR + "/300to450turbulent_spanwise_spectra_time_averaged.png"
    SNAPSHOT_3D_NC_FILE = DATA_DIR + "/300to450snapshot_3d.nc"
    INSTANTANEOUS_SLICE_DIR = DATA_DIR + "/300to450instantaneous_slice/" # NEW: Directory for per-timestep slice files
